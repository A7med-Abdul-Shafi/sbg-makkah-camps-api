...
// const morgan2bathaa = require('../models/morgan2bathaa.js');
    ...
    try {
        ...
        readXlsxFile(filePath).then(rows => {
            ...
            for (let i = 0; i < length; i++) {
                ...
                haramains.push(morgan2bathaa);
            }
            morgan2bathaa.bulkCreate(haramains).then(() => {
                const result = {
                    status: "ok",
...
exports.downloadFile = (req, res) => {
    morgan2bathaa.findAll().then(async objects => {
        var haramains = [];
