...
// const morgan1naseem = require('../models/morgan1naseem.js');
    ...
    try {
        ...
        readXlsxFile(filePath).then(rows => {
            ...
            for (let i = 0; i < length; i++) {
                ...
                haramains.push(morgan1naseem);
            }
            morgan1naseem.bulkCreate(haramains).then(() => {
                const result = {
                    status: "ok",
...
exports.downloadFile = (req, res) => {
    morgan1naseem.findAll().then(async objects => {
        var haramains = [];
